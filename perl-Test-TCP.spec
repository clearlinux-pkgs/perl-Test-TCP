...
Version  : 2.21
Release  : 15
URL      : https://cpan.metacpan.org/authors/id/K/KA/KAZUHO/Test-TCP-2.21.tar.gz
Source0  : https://cpan.metacpan.org/authors/id/K/KA/KAZUHO/Test-TCP-2.21.tar.gz
...
%prep
%setup -q -n Test-TCP-2.21
cd ..
%setup -q -T -D -n Test-TCP-2.21 -b 1
mkdir -p deblicense/
cp -r %{_topdir}/BUILD/debian/* %{_topdir}/BUILD/Test-TCP-2.21/deblicense/
